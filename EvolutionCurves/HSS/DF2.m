...
B=importdata('..\..\data\HSS\HPMS\10.20.100\evaluate\avgIGD\DF2.dat');
y2=log10(B(:,1));

C=importdata('..\..\data\HSS\MoE\10.20.100\evaluate\avgIGD\DF2.dat');
y3=log10(C(:,1));

D=importdata('..\..\data\HSS\IEC\10.20.100\evaluate\avgIGD\DF2.dat');
y4=log10(D(:,1));

E=importdata('..\..\data\HSS\SVR\10.20.100\evaluate\avgIGD\DF2.dat');
y5=log10(E(:,1));

F=importdata('..\..\data\HSS\MRCDMO\10.10.100\evaluate\avgIGD\DF2.dat');
y6=log10(F(:,1));
