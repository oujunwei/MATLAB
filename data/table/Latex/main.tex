...
\hline
Problems  & $(n_t, \tau_t)$ &DNSGAIIA &DNSGAIIB &RND &MOEADKF &NHSS\\
\hline  \multirow{3}{*}{DF1}
&$(10,5)$ &4.608e-2(4.167e-3)$\ddagger$ &1.027e-1(7.737e-3)$\ddagger$ &1.446e-1(1.416e-2)$\ddagger$ &6.226e-2(7.468e-3)$\ddagger$ &1.151e-1(7.280e-3)$\ddagger$ \\
&$(10,10)$ &3.315e-2(2.882e-3)$\ddagger$ &1.004e-1(6.141e-3)$\ddagger$ &4.491e-2(6.014e-3)$\ddagger$ &1.913e-2(1.861e-3)$\ddagger$ &2.802e-2(1.488e-3)$\ddagger$ \\
&$(10,20)$ &2.706e-2(2.848e-3)$\ddagger$ &8.988e-2(7.831e-3)$\ddagger$ &1.117e-2(9.251e-4)$\ddagger$ &6.773e-3(4.247e-4)$\ddagger$ &9.300e-3(2.143e-4)$\ddagger$ \\
\hline  \multirow{3}{*}{DF2}
&$(10,5)$ &2.831e-2(2.409e-3)$\ddagger$ &3.906e-2(5.737e-3)$\ddagger$ &1.163e-1(1.251e-2)$\ddagger$ &8.715e-2(3.515e-3)$\ddagger$ &1.179e-1(6.826e-3)$\ddagger$ \\
&$(10,10)$ &1.805e-2(1.092e-3)$\ddagger$ &1.730e-2(2.777e-3)$\ddagger$ &4.080e-2(3.467e-3)$\ddagger$ &2.974e-2(1.395e-3)$\ddagger$ &3.286e-2(1.156e-3)$\ddagger$ \\
&$(10,20)$ &1.229e-2(6.205e-4)$\ddagger$ &8.862e-3(1.653e-3)$\ddagger$ &1.066e-2(1.003e-3)$\ddagger$ &8.612e-3(4.682e-4)$\ddagger$ &9.219e-3(2.779e-4)$\ddagger$ \\
\hline  \multirow{3}{*}{DF3}
&$(10,5)$ &2.316e-1(8.395e-2)$\ddagger$ &4.003e-1(2.598e-1)$\ddagger$ &2.039e+0(1.652e-3)$\ddagger$ &4.852e-2(9.969e-3)$\ddagger$ &8.381e-2(1.567e-2)$\ddagger$ \\
&$(10,10)$ &1.372e-1(5.522e-2)$\ddagger$ &2.940e-1(2.271e-1)$\ddagger$ &2.031e+0(2.459e-4)$\ddagger$ &2.190e-2(3.656e-3)$\ddagger$ &3.738e-2(8.672e-3)$\ddagger$ \\
&$(10,20)$ &8.035e-2(2.713e-2)$\ddagger$ &1.858e-1(1.318e-1)$\ddagger$ &2.029e+0(6.915e-5)$\ddagger$ &9.076e-3(2.238e-3)$\ddagger$ &1.659e-2(3.437e-3)$\ddagger$ \\
\hline  \multirow{3}{*}{DF4}
&$(10,5)$ &2.842e-1(3.212e-2)$\ddagger$ &3.933e-1(2.900e-2)$\ddagger$ &1.246e+0(1.380e-2)$\ddagger$ &1.399e-1(1.387e-2)$\ddagger$ &1.381e-1(6.820e-3)$\ddagger$ \\
