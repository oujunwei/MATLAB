...
%     str = sprintf('..\\..\\data\\DACP\\MI\\10.30\\PF\\pf_dMOP2_1_%1d.dat',t+1);
%        str = sprintf('..\\..\\data\\DACP\\DNSGAIIgA\\10.20\\PF\\pf_dMOP2_1_%1d.dat',t+1);
 %      str = sprintf('..\\..\\data\\DACP\\DNSGAIIgB\\10.20\\PF\\pf_dMOP2_1_%1d.dat',t+1);
%      str = sprintf('..\\..\\data\\DACP\\NUMSA\\10.20\\PF\\pf_dMOP2_1_%1d.dat',t+1);
       str = sprintf('..\\..\\data\\DACP\\NUMSB\\10.20\\PF\\pf_dMOP2_1_%1d.dat',t+1);
        A=importdata(str);
        F1=A(:,1)
        F2=A(:,2)
        plot(F1,F2,'r.'); %»­¸öÌå
...
title('dMOP2','Fontname','ºÚÌå','Fontsize',18,'FontWeight','bold');
