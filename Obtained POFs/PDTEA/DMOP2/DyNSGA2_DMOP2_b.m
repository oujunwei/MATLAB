...
A=importdata('E:\project\做实验\HLSH_30\PF\pf_DMOP2_0_90.dat');
F1=A(:,1)
F2=A(:,2)
plot(F1,F2,'or'); %画个体
ylabel('f2');
...
A=importdata('E:\project\做实验\HLSH_30\PF\pf_DMOP2_1_100.dat');
F1=A(:,1)
F2=A(:,2)
plot(F1,F2,'or'); %画个体
ylabel('f2');
...
A=importdata('E:\project\做实验\HLSH_30\PF\pf_DMOP2_5_110.dat');
F1=A(:,1)
F2=A(:,2)
plot(F1,F2,'or'); %画个体
hold on

A=importdata('E:\project\做实验\HLSH_30\PF\pf_DMOP2_5_120.dat');
F1=A(:,1)
F2=A(:,2)
plot(F1,F2,'or'); %画个体
hold on
