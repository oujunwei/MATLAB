...
A=importdata('E:\project\做实验\MOEAD_30\PF\pf_DMOP2_0_15.dat');
F1=A(:,1)
F2=A(:,2)
plot(F1,F2,'or'); %画个体
ylabel('f2');
...
A=importdata('E:\project\做实验\MOEAD_30\PF\pf_DMOP2_1_20.dat');
F1=A(:,1)
F2=A(:,2)
plot(F1,F2,'or'); %画个体
ylabel('f2');
...
A=importdata('E:\project\做实验\MOEAD_30\PF\pf_DMOP2_1_25.dat');
F1=A(:,1)
F2=A(:,2)
plot(F1,F2,'or'); %画个体
hold on

A=importdata('E:\project\做实验\MOEAD_30\PF\pf_DMOP2_1_30.dat');
F1=A(:,1)
F2=A(:,2)
plot(F1,F2,'or'); %画个体
hold on
