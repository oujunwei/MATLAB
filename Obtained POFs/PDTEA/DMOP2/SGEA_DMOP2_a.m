...
A=importdata('E:\project\做实验\SGEA_30\PF_SGEA_30\pf_DMOP2_4_15.dat');
F1=A(:,1)
F2=A(:,2)
plot(F1,F2,'or'); %画个体
ylabel('f2');
...
A=importdata('E:\project\做实验\SGEA_30\PF_SGEA_30\pf_DMOP2_3_20.dat');
F1=A(:,1)
F2=A(:,2)
plot(F1,F2,'or'); %画个体
ylabel('f2');
...
A=importdata('E:\project\做实验\SGEA_30\PF_SGEA_30\pf_DMOP2_2_25.dat');
F1=A(:,1)
F2=A(:,2)
plot(F1,F2,'or'); %画个体
hold on

A=importdata('E:\project\做实验\SGEA_30\PF_SGEA_30\pf_DMOP2_7_30.dat');
F1=A(:,1)
F2=A(:,2)
plot(F1,F2,'or'); %画个体
hold on
